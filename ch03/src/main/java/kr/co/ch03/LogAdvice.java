...
public class LogAdvice {
    ...
    @Pointcut("execution(void kr.co.ch03.BasicService.update())")
    public void updatePointcut(){}

    @Pointcut("execution(void kr.co.ch03.BasicService.delete())")
...
//    }
    ...
    public void afterLogUpdate(){
        System.out.println("부가기능 - afterLogUpdate()...");
        System.out.println("------------------------------");
    }

    @Before("deletePointcut()")
    public void beforeLogDelete(){
        System.out.println("------------------------------");
        System.out.println("부가기능 - beforeLogDelete()...");
    }
