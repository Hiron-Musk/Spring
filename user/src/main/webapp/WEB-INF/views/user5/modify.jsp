...
<body>
    ...
    <form action="/user5/modify" method="post">
        <table border="1">
            <tr>
                <td>이름</td>
                <td><input type="text" name="name" value="${user5DTO.name}" readonly></td>
            </tr>
            <tr>
                <td>성별</td>
                <td>
                    <input type="radio" name="gender" value="M" id="M"<c:if test="${user5DTO.gender eq 'M'}">checked</c:if>>
                    <label for="M">M</label>
                    <input type="radio" name="gender" value="F" id="F"<c:if test="${user5DTO.gender eq 'F'}">checked</c:if>>
                    <label for="F">F</label>
                </td>
            </tr>
            <tr>
